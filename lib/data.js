...
export const MODULES = [
  { slug: "stakeholder-directory", emoji: "👥", title: "Stakeholder Directory", color: C.blue, colorName: "electric",
  ...
  { slug: "intel-hub", emoji: "🔍", title: "Intel Hub", color: C.amber, colorName: "amber",
  ...
  { slug: "ai-workspace", emoji: "🤖", title: "AI Workspace", color: C.purple, colorName: "ai",
  ...
  { slug: "target-stakeholders", emoji: "🎯", title: "Target Stakeholders", color: C.red, colorName: "urgent",
  ...
  { slug: "capability-intelligence", emoji: "⚡", title: "Capability Intelligence", color: C.blue, colorName: "electric",
  ...
  { slug: "settings", emoji: "⚙️", title: "Settings & RBAC", color: C.slate, colorName: "slate",
